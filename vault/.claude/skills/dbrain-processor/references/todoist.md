...
- Это приближает к целям проекта/миссии организации?
...
✅ Good:
- "Отправить презентацию [тема]"
- "Созвон с командой по [проект]"
- "Подготовить материалы по [тема]"
- "Написать заявку [тема]"
- "Провести общее совещание на [тема]"
- "Проверить выполнение [задача] "
...
| Keywords | Project |
|----------|---------|
| [Джойнт, Адаин Ло, РЕК Москва, РЕК СПб, Сохнут, Голландцы, доноры, партнеры], клиент, бренд | Client Work |
| [Фонд "Ресурсный центр еврейского просвещения"], команда, найм, процессы | Company Ops |
| продукт, SaaS, MVP | Product |
| пост, [@havura_rc], контент | Content |
